      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <div class="row">
            <form role="form" action="{{route('admin.reports.refill')}}" method="POST" class="col-12">
            @csrf     
            <div class="row">
            ...
            <table id="report" class="display">
              ...
              <tfoot>
                ...
                <tr>
                  ...
                  <th></th>
                  <th id="tot_receivable">{{number_format($total_receivables)}}</th>
                  <th></th>
                  <th></th>
                </tr>
              </tfoot>
...
<script>
  $(document).ready(function() {
    ...
    $("#report").on('search.dt', function() {
        $("#tot_receivable").html(codeListTable.column( 4, {page:'current'} ).data().sum());
