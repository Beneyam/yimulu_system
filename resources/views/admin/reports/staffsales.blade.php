      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <div class="row">
              <div class="col-sm-10">
                <h3 class="box-title">Card Sales</h3>
              </div>

            </div>
            <div class="row">
              <form role="form" action="{{route('admin.reports.staffsales')}}" method="POST" class="col-12">
                @csrf
                <div class="row">
              ...
              <table id="report" class="display">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    $amount=$sale->amount*$sale->face_value;
                    $total_amount+=$amount;
                    @endphp

                    <td>{{$sale->yimulu_sales_name}}</td>
                    <td>{{$sale->type}}</td>
